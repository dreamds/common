                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="100%" align="center" colspan="8">
                                ...
                                <input type="button" onclick="$.BKD.redirect('<?php echo HOME_DOMAIN; ?>configure/add');" value="添加配置" class="submit">
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <table class="list">
                ...
                <tbody>
                    <?php foreach($list as $val) { ?>
                        <tr>
                            <td>
                                <a onclick="$.BKD.open('iframe', '<?php echo HOME_DOMAIN;?>configure/detail?configure_id=<?php echo $val['configure_id'];?>&amp;nobar=1', '800px', '320px')" href="#"><?php echo $val['configure_name']; ?></a>
                            </td>
