<div id="main-content"> <!-- Main Content Section with everything -->
            ...
            <div class="content-box">		
                ...
                <div class="content-box-header">
                    ...
                    <h3>添加菜单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='color:#FF0000;'>【一级菜单】</span>:<?php echo $programs['progName'] ?></h3>
                
                </div><!-- End .content-box-header -->
                
                <div class="content-box-content">
                        <form name="property_add" method="post" action="<?php echo HOME_DOMAIN ?>programs/add_second_program" class="search-content" onSubmit="return check_submit()" enctype="multipart/form-data">
                            <input type="hidden" name="act" value="add" />
                            <input type="hidden" name="id" value="<?php echo $id ?>" />
                            <input type="hidden" name="systemId" value="<?php echo $systemId ?>" />
                            <input type="hidden" name="sysGroupId" value="<?php echo $sysGroupId ?>" />
                            <table>
                            <colgroup>
                                    <col width="10%"/>
                                    <col width="30%"/>
