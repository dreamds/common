...
<head>
    ...
    <?php echo  script_tag(array('jquery/jquery-1.8.3.min.js', 'layer/layer.js', 'laydate/laydate.js', 'jquery/jquery.validate.1.9.min.js','jquery/jquery.metadata.js', 'My97DatePicker/WdatePicker.js', 'base.js', 'vue.min.js', 'validate.js', 'jquery/plugins/jquery.form.js'), $js) ?>
    <!--[if IE 6]>
