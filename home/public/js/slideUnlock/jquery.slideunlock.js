...
function SliderUnlock(elm, options, success, always) {
    ...
    var opts = {
        labelTip: typeof(options.labelTip)!=="undefined" ? options.labelTip : "留言请拖动滑块到右侧",         //滑动条提示文字
        successLabelTip: typeof(options.successLabelTip)!=='undefined' ? options.successLabelTip : "已解锁", //解锁成功提示文字
        duration: typeof(options.duration)!=='undefined'||!isNaN(options.duration) ? options.duration : 200, //重置滑块的滑动时间(快慢)
