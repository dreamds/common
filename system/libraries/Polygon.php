 ...
 * @date        2016-12-20
 * @category    Api
 * @link        https://github.com/hannesvdvreken/pip
 *
 * @version     $Id$
 */
class CI_Polygon
{
    ...
    /*
    {
        "name": "hannesvdvreken/pip",
        "description": "The Polygon class",
        "keywords": ["pip","GeoJSON","Polygon","Geometry","Geo","Point-in-polygon"],
        "authors": [
            {
    ...
    */
     ...
     * 设置一个多边形
     */
    public function setPolygon(array $coordinates = null)
    {
        if ($coordinates) {
            $this->setOutline($coordinates);
        } else {
