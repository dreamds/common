...
class PushPayload {
    ...
    public function  isGlobalExceedLength() {
        ...
        return $ios > 1200 || $winphone > 1200 || $android > 1000;
    }


    public function  getGlobalLength() {
        $message = $this->message;
        $notification = $this->notification;
        ...
        if (!is_null($notification)) {
            ...
            // IOS8及以上现在可以是2048字节了
            // if ($ios < 220) {
            //     return 'ios notification gt 220 is ' . $ios;
            // }
        ...
        return "ios:{$ios} android:{$android} wp:{$winphone}";
    }
} 