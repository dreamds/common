...
class CI_Pagination {
    ...
    var $cur_page            = 0;  //----当前页码----
    var $first_link          = '&lt;';
    var $next_link           = '<span class="page-next"></span>';
    var $prev_link           = '<span class="page-prev"></span>';
    var $last_link           = '&gt;';
    var $full_tag_open       = '<span class="pagination-page">';
    var $full_tag_close      = '</span><div class="clearfix"></div></div>';
    var $first_tag_open      = '';
    var $first_tag_close     = '';
    var $last_tag_open       = '';
    var $last_tag_close      = '';
    var $cur_tag_open        = '<span class="pagination-current">';
    ...
    var $num_tag_open        = '';
    var $num_tag_close       = '';
    var $break_tag           = '<span class="pagination-split">...</span>';
    var $zero_tag            = '<div class="pagination"><span class="pagination-total">共<span class="page-total">0</span>项</span></div>';
    var $character_tag_open  = '<div class="pagination"><span class="pagination-total">共<span class="page-total">';
    var $character_tag_close = '</span>项</span>';
    var $goto_tag            = '<input style="border:1px solid #D5D5D5;padding:6px 4px;border-radius:4px;width:20px;" type="text" /> <input style="border-radius:4px;color:#FFFFFF !important;border:1px solid #459300 !important;background:url(/image/bg-button-green.gif) repeat-x scroll left top #459300 !important" type="button" value="跳转"';
    ...
    public function create_page_bar($is_ajax)
    {
...
EOT;
        ...
        $pre_output = $script;
        $pre_output .= $this->character_tag_open . $this->total_rows . substr($this->character_tag_close, 0, -7) . ($is_ajax ? '' : $this->goto_tag) . '</span>';
     ...
     * @param   bool    $is_ajax    是否是 ajax
     *
     * @return void
     */
    public function get_page_bar($total, $page_size = '', $max_page = '', $is_ajax = false)
    {
        ...
        return $pagination->create_page_bar($is_ajax);
    }
}